...
<head runat="server">
    ...
    <!--<script src="http://www.associaciobaleardemindfulness.com/administracio/lib/jquery-1.11.3/jquery-1.11.3.min.js"></script>-->
    ...
    <script src="lib/bootstrap-select/bootstrap-select-1.13.9/dist/js/bootstrap-select.min.js"></script>
    <title>Visors</title>
</head>
<body>
    ...
    <script type="text/javascript">
        ...
        function revisarGrupBotons(){
            /*if($("#title").text() == "Projectes") $(".btn-group").css("display", "block");
            else $(".btn-group").css("display", "none");*/
            // https://stackoverflow.com/questions/13757051/how-to-show-all-child-nodes-in-jquery revisar si fer-ho així o amb classe, animació show/hide
        ...
        function omplirModal(trSeleccionat){
            ...
            //var valors = "{accio:modificar_"+$("#title").text();
            ...
            if($(this).text().trim() == "Nou"){
                ...
                console.log(inputs);
                for(var i = 0; i < inputs.length; i++){
                    console.log(i+"-"+$(inputs[i]).attr('readonly'));
                    ...
                    if (data.indexOf("Error")!=-1){
                        ...
                        */
                        ...
                        resultat += `
                                            ...
                                            <ul class="list-group list-group-flush" id="llistat_afegits">
        ...
        $(document).ready(function(){
            ...
            $(".menu-item").on("click", function () {
                //console.log("panel.aspx?panel=" + $(this).text()+"&userName=<%=nomUsuari%>");
